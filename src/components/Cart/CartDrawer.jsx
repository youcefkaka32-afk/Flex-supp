    ...
    <>
      ...
      <aside className={`cart-drawer${drawerOpen ? ' open' : ''}`} role="dialog" aria-modal="true" aria-label={t('cart.title')}>
        ...
        <div className="cart-drawer__header">
          ...
          <button type="button" className="cart-drawer__close" onClick={closeDrawer} aria-label="Close">✕</button>
        </div>
        ...
        {items.length > 0 && (
          <div className="cart-drawer__footer">
            ...
            <button type="button" className="cart-drawer__checkout-btn" onClick={openCheckout}>
